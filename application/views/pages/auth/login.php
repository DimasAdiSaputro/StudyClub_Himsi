    ...
    <div class="row justify-content-center mt-5">
        <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 mt-5">
            <div class="card bg-dark shadow-lg">
                <div class="card-body">
                    <h3 class="h3 mb-4 card-title text-center text-uppercase text-white">login</h3>
                    ...
                    <form action="" class="form" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control bg-transparent text-white" name="password" id="password" type="password" placeholder="Password.." />
